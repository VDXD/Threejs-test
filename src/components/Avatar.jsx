...
export function Avatar(props) {
  ...
  const { animations: fightingIdleAnimation } = useFBX(
    "/animations/Fight Idle.fbx"
  );
  const { animations: punchingAnimation } = useFBX("/animations/Punching.fbx");
  const { animations: kickingAnimation } = useFBX("/animations/Kicking.fbx");
  const { animations: standAnimation } = useFBX(
    "/animations/Jab Cross.fbx"
  );

  fightingIdleAnimation[0].name = "Idle";
